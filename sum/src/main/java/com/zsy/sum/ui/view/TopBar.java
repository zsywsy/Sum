...
import com.zsy.sum.ui.utils.ViewUtils;
        ...
        leftTv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (topbarOnClickListener != null)
                    topbarOnClickListener.leftOnClick(leftTv);
            }
        });
...
//        }
        rightTv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (topbarOnClickListener != null)
                    topbarOnClickListener.rightOnClick(rightTv);
            }
        });
...
//    }
    ...
    public static abstract class LeftOnClickListener implements TopbarOnClickListener {
    ...
    public static abstract class RightOnClickListener implements TopbarOnClickListener {
